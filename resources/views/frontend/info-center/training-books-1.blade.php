...
@section('title')
    Uzmanlık Eğitimi Kitabları - 2 - Türk Kulak Burun Boğaz ve Baş Boyun Cerrahisi Derneği
@endsection
@section('content')
    @push('styles')
                ...
                <div class="col-12">
                    <div class="tp-breadcrumb__content z-index-5">
                        <div class="tp-breadcrumb__list">
                            ...
                            <span class="dvdr"><i class="fa-sharp fa-solid fa-slash-forward"></i></span>
                            <span>Uzmanlık Eğitimi Kitabları - 2</span>
                        </div>
                        <h3 class="tp-breadcrumb__title">Uzmanlık Eğitimi Kitabları - 2</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>Kulak Burun Boğaz ve Baş Boyun Cerrahisi Uzmanlık Eğitimi 2019</td>
                    </tr>
                    </tbody>
                </table>
            </div>
