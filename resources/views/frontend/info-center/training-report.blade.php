...
@section('title')
    Tıpta Uzmanlık Eğitimi Karnesi - Türk Kulak Burun Boğaz ve Baş Boyun Cerrahisi Derneği
@endsection
@section('content')
    @push('styles')
                ...
                <div class="col-12">
                    <div class="tp-breadcrumb__content z-index-5">
                        <div class="tp-breadcrumb__list">
                            ...
                            <span class="dvdr"><i class="fa-sharp fa-solid fa-slash-forward"></i></span>
                            <span>Tıpta Uzmanlık Eğitimi Karnesi</span>
                        </div>
                        <h3 class="tp-breadcrumb__title">Tıpta Uzmanlık Eğitimi Karnesi</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>Tıpta Uzmanlık Eğitimi Karnesi</td>
                    </tr>
                    <tr>
                        <td>
                            <div id="wrap">
                        ...
                        <td>Uzmanlık Eğitimi Karnesi Kullanım Rehberi</td>
                    </tr>
                    </tbody>
                </table>
            </div>
