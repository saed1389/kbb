...
@section('title')
    Yönetim Kurulu - Türk Kulak Burun Boğaz ve Baş Boyun Cerrahisi Derneği
@endsection
@section('content')
    @push('styles')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="tp-breadcrumb__content z-index-5">
                        ...
                        <h3 class="tp-breadcrumb__title">Yönetim Kurulu</h3>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="tp-team-2__wrapper">
                            <div class="tp-team-2__item text-center">
                                ...
                                <div class="tp-team-2__content">
                                    <div class="tp-team-2__author-info">
                                        <a>
                                            <h4 class="tp-team-2__author-name">@php
                                                    if ($item->position == 1) {
                                                        $position = 'Başkan';
