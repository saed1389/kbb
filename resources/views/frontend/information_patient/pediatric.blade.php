                    ...
                    <div class="row">
                        ...
                        <div id="menuContent">
                            <div class="panel-group" id="accordion">
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga1"><strong><a href="#collapsea1" data-bs-toggle="collapse">Çocuklarda sinüzit olur mu?</a></strong></div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga2"><strong><a href="#collapsea2" data-bs-toggle="collapse">Çocuklarda alerjik burun hastalığı (saman nezlesi) olur mu?</a></strong></div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga3"><strong><a href="#collapsea3" data-bs-toggle="collapse">Çocuklar uykuda neden horlar? Horlamak ne zaman tehlikelidir?</a></strong></div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga4"><strong><a href="#collapsea4" data-bs-toggle="collapse">Bademcik geniz eti problemleri hangi sağlık sorunlarına yol açar?</a></strong></div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga5"><strong><a href="#collapsea5" data-bs-toggle="collapse">Çocuğum hangi yaşta bademcik geniz eti ameliyatı olmalı?</a></strong></div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga6"><strong><a href="#collapsea6" data-bs-toggle="collapse">Çocuğum bademcik geniz eti ameliyatı olması gerekli mi? Hangi durumlarda bu ameliyat zorunluluktur?</a></strong></div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga7"><strong><a href="#collapsea7" data-bs-toggle="collapse">Bademcik ve geniz eti ameliyatı geçirenler nelere dikkat etmelidir?</a></strong></div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga8"><strong><a href="#collapsea8" data-bs-toggle="collapse">Bademcik ameliyatı olanlar daha kolay mı hasta olur?</a></strong></div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga9"><strong><a href="#collapsea9" data-bs-toggle="collapse">Çocuğumun kulak zarının arkasında neden sıvı birikimi oldu?</a></strong></div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga10"><strong><a href="#collapsea10" data-bs-toggle="collapse">Kulak zarı arkasında sıvı birikimi nasıl tedavi edilir?</a></strong></div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga11"><strong><a href="#collapsea11" data-bs-toggle="collapse">Kulak zarına tüp takılması ameliyatı hangi durumda ve hangi yaşta yapılabilir?</a></strong></div>
