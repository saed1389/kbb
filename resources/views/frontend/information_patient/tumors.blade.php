                    ...
                    <div class="row">
                        ...
                        <div id="menuContent">
                            <div aria-multiselectable="true" class="panel-group" id="accordion" role="tablist">
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga1"><strong><a href="#collapsea1" data-bs-toggle="collapse">Kötü huylu tümörlerde sadece tümörün çıkarılması yeterli midir?</a></strong></div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga2"><strong><a href="#collapsea2" data-bs-toggle="collapse">Gırtlak kanseri nedeniyle ameliyat olan bir hastanın boğazında kalıcı delik olur mu?</a></strong></div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga3"><strong><a href="#collapsea3" data-bs-toggle="collapse">Gırtlak kanseri nedeniyle ameliyat olan bir hasta bir daha konuşamaz mı?</a></strong></div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga4"><strong><a href="#collapsea4" data-bs-toggle="collapse">Geniz tümörlerinin bulguları nelerdir?</a></strong></div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga5"><strong><a href="#collapsea5" data-bs-toggle="collapse">Geniz tümörleri nasıl tedavi edilmektedir?</a></strong></div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga6"><strong><a href="#collapsea6" data-bs-toggle="collapse">Kulak memesi altında büyümekte olan bir kitle önemli midir?</a></strong></div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga7"><strong><a href="#collapsea7" data-bs-toggle="collapse">Kulak çınlaması bir tümörün bulgusu olabilir mi?</a></strong></div>
                                ...
                                <div class="card mt-2">
                                    <div class="card-header" id="headinga8"><strong><a href="#collapsea8" data-bs-toggle="collapse">Burun kanaması bir tümörün bulgusu olabilir mi?</a></strong></div>
