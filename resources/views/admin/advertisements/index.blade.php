                    ...
                    <div class="table table-striped">
                        <table class="table">
                            ...
                            @foreach($advertisements as $item)
                                <tr @if($item->status == 1) class="bg-success" @else class="bg-danger" @endif>
                                    <td>{{ $loop->iteration }}</td>
                                    <td><img src="{{ asset($item->image) }}" class="w-20 rounded" alt=""></td>
                                    <td>{{ $item->title }}</td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-control" name="place" id="place" required>
                                        ...
                                        <option value="1">Sliderın sağ tarafı</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <img src="{{ asset('assets/img/images.png') }}" id="showImage" class="rounded w-50 mt-2" alt="" />
                                </div>
                                @error('image')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                                <div class="col-md-12 mb-3">
                                    <label class="switch switch-square">
                                        <input type="checkbox" class="switch-input" value="1" checked name="status" />
                                ...
                                <div class="col-md-12 mb-4">
                                    <button class="btn btn-success" type="submit">Reklam Ekle</button>
                                </div>
                            </div>
                        </form>
                    </div>
