    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <form method="post" action="{{ route('competencesPoint.store') }}">
                        @csrf
                        <div class="card mb-4">
                            <h5 class="card-header">Yeni Yeterlik Puan Ekle</h5>
                            <div class="card-body">
                                <div>
                                    <label for="title" class="form-label">Başlık</label>
                                    <input type="text" class="form-control" id="title" name="title" placeholder="Yeterlik Başlıki Giriniz" required >
                                </div>
                                <div class="mt-3">
                                    <label for="point" class="form-label">Puan</label>
                                    <input type="number" class="form-control" id="point" name="point" placeholder="Yeterlik Puani Giriniz" required >
                                </div>
                                <div class="mt-3">
