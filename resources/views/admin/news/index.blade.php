            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                        <a href="{{ route('news.create') }}" class="btn btn-primary waves-effect waves-light float-end ">
                            Yeni Haber Ekle
                        </a>
            ...
            $(document).ready(function () {
                ...
                $('#example').DataTable({
                    ...
                    aoColumns : [
                        ...
                        { data: null,
                            render: function (data, type, row) {
                                return '<a href="{{ url("admin/news") }}/' + row.id + '/edit" class="btn btn-primary">Düzenle</a> <button href="{{ url("admin/news/delete") }}/' + row.id + '" type="button" class="btn btn-danger" id="delete" >Sil</button>';
                            }, "searchable": false, "orderable": false
                        },
                    ],
                    "columnDefs": [{
            ...
            $(document).ready(function(){
                $(document).on('change', 'input.switch-input.active', function() {
                    ...
                    $.ajax({
                        ...
                        url: "{{ url('/admin/news/changeStatus') }}/"+check_id+"/"+check_active,
