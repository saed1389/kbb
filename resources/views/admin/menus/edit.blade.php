...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y mb-5">
        <div class="card">
            <h5 class="card-header">Menü Düzenleme</h5>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Menü Düzenleme</li>
                    ...
                    <form class="" action="{{ route('menus.update', $menu->id) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-5 mb-3">
                                ...
                                <input type="text" id="title" name="title" class="form-control" value="{{ $menu->title }}" placeholder="Menü Başlık Giriniz" required>
                                @error('title')
                            ...
                            <div class="col-md-5 mb-3">
                                ...
                                <input type="text" id="title_en" name="title_en" value="{{ $menu->title_en }}" class="form-control" placeholder="Menü Başlık (en) Giriniz">
                            </div>
                            <div class="col-md-2 mb-3">
                                <div class="form-label mb-3">Yeni Sayfa Açılış Durumu</div>
                                <label class="switch switch-square">
                                    <input type="checkbox" class="switch-input" value="1" name="blank" @checked($menu->blank == 1) />
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="href" value="{{ $menu->href }}" name="href" class="form-control" placeholder="Menü Href Giriniz">
                            </div>
                            <div class="col-md-6 mb-4">
                                ...
                                <select id="parent_id" class="selectpicker w-100" name="parent_id" data-style="btn-default" tabindex="null">
                                    <option value="0" @selected($menu->parent_id == 0)>Ana Menü</option>
                                    @foreach($parentMenu as $item)
                                        <option value="{{ $item->id }}" @selected($menu->parent_id == $item->id) >{{ $item->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control editor" id="editor" name="body">{!! $menu->body !!}</textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label class="form-label" for="editor">Menü İçeriği (en)</label>
                                <textarea class="form-control editor" id="editor" name="content_en">{!! $menu->content_en !!}</textarea>
                            </div>
                            ...
                            <div class="col-md-4 mb-4">
                                ...
                                <select id="show" class="selectpicker w-100" name="show" data-style="btn-default" tabindex="null">
                                    <option value="1" @selected($menu->show == 1)>Evet</option>
                                    <option value="0" @selected($menu->show == 0)>Hayır</option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-4">
                                ...
                                <select id="permission" class="selectpicker w-100" name="permission" data-style="btn-default" tabindex="null">
                                    <option value="1" @selected($menu->permission == 1)>Herkese Açık</option>
                                    <option value="2" @selected($menu->permission == 2)>Üyelere Özel</option>
                                </select>
                            </div>
                            <div class="col-md-4 mb-4">
                                ...
                                <select id="status" class="selectpicker w-100" name="status" data-style="btn-default" tabindex="null">
                                    <option class="text-success" value="1" @selected($menu->status == 1) >Yayınla</option>
                                    <option class="text-danger" value="0" @selected($menu->status == 0) >Taslak olarak kaydet</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-primary">Menü Güncelle</button>
                            </div>
                        </div>
                    </form>
                </div>
