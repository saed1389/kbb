...
@section('title') Yeterlik Yürütme Kurulu @endsection
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <h5 class="card-header">Yeterlik Yürütme Kurulu</h5>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Yeterlik Yürütme Kurulu</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-md-4 ">
            ...
            <div class="row">
                        ...
                        <table class="table">
                            ...
                            @forelse($lists as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('committees.qualificationEdit', $item->id) }}" class="btn btn-label-primary btn-sm waves-effect editBtn" >Düzenle</a>
                ...
                <div class="col-md-4">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('committees.qualificationUpdate', $user->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
