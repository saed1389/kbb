                                                                                        ...
                                                                                        <td width="67%" style="padding-left: 10px; padding-bottom: 10px;">
                                                                                            <font face="Arial">
                                                                                                <a href="http://www.kbb.org.tr/" target="_blank">
                                                                                                    <img src="{{ asset('/assets/img/logoheadvefat.png') }}" alt="" width="100%">
                                                                                                </a>
                                                                                            </font>
                                                                                        </td>
                                                                                        <td width="33%" align="center">
                                                                                            <font face="Arial">
                                                                                                ...
                                                                                                <a href="https://www.facebook.com/T%C3%BCrk-Kulak-Burun-Bo%C4%9Faz-ve-Ba%C5%9F-Boyun-Cerrahisi-Derne%C4%9Fi-493168617369439/" target="_blank">
                                                                                                    <img src="{{ asset('/assets/img/face.png') }}" alt="" width="32" height="31" style="margin-right: 1px; margin-top: 5px;">
                                                                                                </a> <a href="https://www.instagram.com/tkbbvebbcd/" target="_blank">
                                                                                                    <img src="{{ asset('/assets/img/instagram.png') }}" alt="" width="33" height="31" style="margin-right: 1px; margin-top: 5px;">
                                                                                                </a> <a href="https://twitter.com/tkbbvebbcd" target="_blank">
                                                                                                    <img src="{{ asset('/assets/img/twitter.png') }}" alt="" width="32" height="31" style="margin-top: 5px;">
                                                                                                </a>
                                                                                            </font>
                                                                                        </td>
                                                                                    </tr>
