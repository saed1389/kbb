                ...
                $('#example').DataTable({
                    ...
                    aoColumns : [
                        ...
                        { data: 'gender',
                            name: 'gender',
                            render: function (data) {
                                return data === 1 ? 'Erkek' : (data === 2 ? 'Kadın' : '');
                            },
                            "searchable": false, "orderable": false},
                        { data: 'mobile', name: 'mobile', "searchable": false, "orderable": false},
                        { data: 'email', name: 'email', "searchable": false, "orderable": true},
                        { data: "created_at",
                            name: 'created_at',
                            render: function (data) {
                        ...
                        { data: null,
                            render: function (data, type, row) {
                                return '<a href="{{ url("admin/users/members") }}/' + row.id + '/edit" class="btn btn-primary btn-sm">Düzenle</a> <button href="{{ url("admin/users/members/delete") }}/' + row.id + '" type="button" class="btn btn-sm btn-danger" id="delete" >Sil</button>';
                            }, "searchable": false, "orderable": false
                        },
                    ],
