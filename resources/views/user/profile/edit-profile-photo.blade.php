                    ...
                    <div class="col-md-8">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('user.profile', $user->id) }}">Profil </a>
                                </li>
    ...
    <div class="modal animate__animated animate__rollIn" id="webcam" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('user-profile-webcam-store', $user->id) }}" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal animate__animated animate__rollIn" id="file" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('user-profile-file-store', $user->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-xl-6">
