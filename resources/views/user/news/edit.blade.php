        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('userIndex.news') }}">Haber Yönetimi </a>
                                </li>
                    ...
                    <form class="" action="{{ route('userUpdate.news', $news->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('userIndex.news') }}" class="btn btn-secondary">Geri dön</a>
